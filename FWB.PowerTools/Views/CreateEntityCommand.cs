...
namespace FWB.PowerTools.Views
{
    ...
    internal sealed class CreateEntityCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("78961b4b-d7ba-4a15-9e06-9cce9c155076");
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            ToolWindowPane window = this.package.FindToolWindow(typeof(CreateEntity), 0, true);
