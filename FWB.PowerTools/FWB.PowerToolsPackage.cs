...
namespace FWB.PowerTools
{
    ...
    [Guid(FWBPowerToolsPackage.PackageGuidString)]
    [ProvideMenuResource("Menus.ctmenu", 1)]
    [ProvideToolWindow(typeof(FWB.PowerTools.Views.CreateEntity))]
    public sealed class FWBPowerToolsPackage : AsyncPackage
    {
        /// <summary>
        /// FWB.PowerToolsPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "945fbf43-c51f-4eef-89f9-ca8754af32a1";
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            if (commandService != null)
            {
                ...
                var toolWindowCommandID = new CommandID(new Guid("945fbf43-c51f-4eef-89f9-ca8754af32a1"), 0x0100);
                ...
                var dropdownOption1CommandID = new CommandID(new Guid("945fbf43-c51f-4eef-89f9-ca8754af32a1"), 0x0302);
